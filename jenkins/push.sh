...
aws ecr get-login-password --region ap-southeast-1 | docker login --username AWS --password-stdin 709026135780.dkr.ecr.ap-southeast-1.amazonaws.com/nodejs:latest
